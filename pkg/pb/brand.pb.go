...
func (x *CreateBrandRequest) Reset() {
	*x = CreateBrandRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_brand_proto_msgTypes[0]
...
func (*CreateBrandRequest) Descriptor() ([]byte, []int) {
	return file_pkg_pb_brand_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBrandResponse) Reset() {
	*x = CreateBrandResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_brand_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateBrandResponse) Descriptor() ([]byte, []int) {
	return file_pkg_pb_brand_proto_rawDescGZIP(), []int{1}
}
...
func (x *FindOneData) Reset() {
	*x = FindOneData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_brand_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindOneData) Descriptor() ([]byte, []int) {
	return file_pkg_pb_brand_proto_rawDescGZIP(), []int{2}
}
...
func (x *FindOneRequest) Reset() {
	*x = FindOneRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_brand_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindOneRequest) Descriptor() ([]byte, []int) {
	return file_pkg_pb_brand_proto_rawDescGZIP(), []int{3}
}
...
func (x *FindOneResponse) Reset() {
	*x = FindOneResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_brand_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindOneResponse) Descriptor() ([]byte, []int) {
	return file_pkg_pb_brand_proto_rawDescGZIP(), []int{4}
}
...
var File_pkg_pb_brand_proto protoreflect.FileDescriptor

var file_pkg_pb_brand_proto_rawDesc = []byte{
	0x0a, 0x12, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x22, 0x56, 0x0a, 0x12, 0x43,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x22, 0x53, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x72, 0x61,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x5f, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64,
	0x4f, 0x6e, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x72, 0x61, 0x6e, 0x64,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x72, 0x61,
	0x6e, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x61,
	0x74, 0x65, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x22, 0x20, 0x0a, 0x0e, 0x46, 0x69, 0x6e,
	...
	,
...
var (
	file_pkg_pb_brand_proto_rawDescOnce sync.Once
	file_pkg_pb_brand_proto_rawDescData = file_pkg_pb_brand_proto_rawDesc
)

func file_pkg_pb_brand_proto_rawDescGZIP() []byte {
	file_pkg_pb_brand_proto_rawDescOnce.Do(func() {
		file_pkg_pb_brand_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_pb_brand_proto_rawDescData)
	})
	return file_pkg_pb_brand_proto_rawDescData
}

var file_pkg_pb_brand_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_pb_brand_proto_goTypes = []interface{}{
...
var file_pkg_pb_brand_proto_depIdxs = []int32{
	...
	1, // 3: brand.BrandService.CreateBrand:output_type -> brand.CreateBrandResponse
...
func init() { file_pkg_pb_brand_proto_init() }
func file_pkg_pb_brand_proto_init() {
	if File_pkg_pb_brand_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_pb_brand_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_brand_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_brand_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_brand_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_brand_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_pb_brand_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_pb_brand_proto_goTypes,
		DependencyIndexes: file_pkg_pb_brand_proto_depIdxs,
		MessageInfos:      file_pkg_pb_brand_proto_msgTypes,
	}.Build()
	File_pkg_pb_brand_proto = out.File
	file_pkg_pb_brand_proto_rawDesc = nil
	file_pkg_pb_brand_proto_goTypes = nil
	file_pkg_pb_brand_proto_depIdxs = nil
}
